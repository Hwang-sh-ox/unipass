                    ...
                    <div className="animate-in fade-in duration-500 space-y-6">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div className="p-4 bg-blue-50 border border-blue-100 rounded-xl flex items-start gap-3">
                          ...
                          <div>
                            <p className="text-sm font-bold text-blue-900">상위 50% 합격선</p>
                            <p className="text-xs text-blue-700">해당 학과 입학생 중 성적순 상위 50% 지점의 평균 성적입니다.</p>
                          </div>
                        </div>
                        <div className="p-4 bg-emerald-50 border border-emerald-100 rounded-xl flex items-start gap-3">
                          ...
                          <div>
                            <p className="text-sm font-bold text-emerald-900">상위 70% 합격선 (커트라인 근접)</p>
                            <p className="text-xs text-emerald-700">일반적으로 최종 합격자의 하위권 성적을 가늠하는 지표입니다.</p>
                          </div>
                        </div>
                      </div>
